...
import com.github.duskbyte.assets.i18n.DefaultTranslateComponent;
...
/**
 * Base class for DuskByte addons.
 */
public abstract class DuskAddon {
    ...
    protected DuskAddon(String addonId) {
