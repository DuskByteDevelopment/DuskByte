...
public class Render3DUtils {
    ...
    private static final RenderType FILLED_BOX = RenderType.create("duskbyte_filled_box",
    ...
    public static final RenderType LINES = RenderType.create("duskbyte_lines", RenderSetup.builder(LINES_PIPELINE)
            .setLayeringTransform(LayeringTransform.VIEW_OFFSET_Z_LAYERING)
