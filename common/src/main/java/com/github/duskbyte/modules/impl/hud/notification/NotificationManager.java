package com.github.duskbyte.modules.impl.hud.notification;
...
public class NotificationManager {
    ...
    private final TranslateComponent enableComponent = DuskTranslate.create("modules.notifications hud", "enabled");
    private final TranslateComponent disableComponent = DuskTranslate.create("modules.notifications hud", "disabled");
