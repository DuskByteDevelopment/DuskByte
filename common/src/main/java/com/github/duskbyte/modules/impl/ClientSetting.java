package com.github.duskbyte.modules.impl;
...
public class ClientSetting extends Module {
    ...
    public final EnumSetting<MainMenuScreen.Background> mainMenuBackground = enumSetting("MainMenu Background", MainMenuScreen.Background.CYBER_FUJI, useMainMenu::getValue);
