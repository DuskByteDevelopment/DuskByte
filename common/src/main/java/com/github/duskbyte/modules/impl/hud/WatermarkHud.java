package com.github.duskbyte.modules.impl.hud;
...
public class WatermarkHud extends HudModule {
    ...
    private final ColorSetting brandColor = colorSetting("Brand Color", new Color(100, 170, 255, 255), () -> mode.is(Mode.Modern));
    private final ColorSetting accentColor = colorSetting("Accent Color", new Color(100, 170, 255, 255), () -> mode.is(Mode.Modern));
    ...
    public void render(GuiGraphicsExtractor graphics, DeltaTracker deltaTracker) {
        ...
        if (mode.is(Mode.Tradition)) {
            String traditionText = "DUSK BYTE";
