...
public class FXAAShader {
    ...
    private void ensureProgram() {
        if (this.uniforms == null) {
            this.uniforms = new MappableRingBuffer(() -> "DuskFXAAUniforms", GpuBuffer.USAGE_MAP_WRITE | GpuBuffer.USAGE_UNIFORM, UNIFORMS_SIZE);
        }
    ...
    private void ensureInput(RenderTarget framebuffer) {
        ...
        if (this.input == null) {
            this.input = new TextureTarget("Dusk FXAA Input", fbWidth, fbHeight, false);
        }
