package com.github.duskbyte.graphics.shaders;
...
public class GlslSandBox implements AutoCloseable {
    ...
    public static final Identifier LANDSCAPE = ResourceLocationUtils.getIdentifier("menu/landscape");
    public static final Identifier NEBULA = ResourceLocationUtils.getIdentifier("menu/nebula");
    public static final Identifier CYBER_FUJI = ResourceLocationUtils.getIdentifier("menu/cyber_fuji");
