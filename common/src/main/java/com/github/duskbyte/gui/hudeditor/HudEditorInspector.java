...
public class HudEditorInspector {
    ...
    private static final TranslateComponent titleComponent = DuskTranslate.create("gui", "inspector");
    private static final TranslateComponent selectComponent = DuskTranslate.create("gui", "inspector.select");
