...
public class ModuleDetailPanel {
    ...
    private static final TranslateComponent toggleComponent = DuskTranslate.create("keybind", "toggle");
    private static final TranslateComponent holdComponent = DuskTranslate.create("keybind", "hold");
    private static final TranslateComponent noneComponent = DuskTranslate.create("keybind", "none");
    private static final TranslateComponent visibleComponent = DuskTranslate.create("module", "visible");
    private static final TranslateComponent hiddenComponent = DuskTranslate.create("module", "hidden");
    private static final TranslateComponent noModuleComponent = DuskTranslate.create("gui", "no_module");
