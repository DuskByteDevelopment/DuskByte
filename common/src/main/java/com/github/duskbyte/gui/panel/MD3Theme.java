...
public class MD3Theme {
    ...
    public static Color SHADOW = new Color(0, 0, 0, 80);

    public static Color SURFACE = new Color(10, 10, 15, 238);
    public static Color SURFACE_DIM = new Color(6, 6, 10, 232);
    public static Color SURFACE_CONTAINER_LOW = new Color(15, 15, 26, 240);
    public static Color SURFACE_CONTAINER = new Color(20, 20, 34, 244);
    public static Color SURFACE_CONTAINER_HIGH = new Color(28, 28, 44, 248);
    public static Color SURFACE_CONTAINER_HIGHEST = new Color(36, 36, 56, 252);

    public static Color OUTLINE = new Color(0, 212, 255, 160);
    public static Color OUTLINE_SOFT = new Color(0, 212, 255, 80);

    public static Color PRIMARY = new Color(0, 212, 255);
    public static Color ON_PRIMARY = new Color(0, 26, 36);
    public static Color PRIMARY_CONTAINER = new Color(0, 51, 73, 236);
    public static Color ON_PRIMARY_CONTAINER = new Color(179, 240, 255);

    public static Color SECONDARY = new Color(255, 0, 170);
    public static Color ON_SECONDARY = new Color(42, 0, 18);
    public static Color SECONDARY_CONTAINER = new Color(74, 0, 42, 236);
    public static Color ON_SECONDARY_CONTAINER = new Color(255, 179, 224);

    public static Color TERTIARY = new Color(0, 255, 136);
    public static Color ON_TERTIARY = new Color(0, 42, 20);
    public static Color TERTIARY_CONTAINER = new Color(0, 77, 40, 236);
    public static Color ON_TERTIARY_CONTAINER = new Color(179, 255, 212);
    public static Color INVERSE_SURFACE = new Color(232, 232, 238);
    public static Color INVERSE_ON_SURFACE = new Color(26, 26, 36);

    public static Color TEXT_PRIMARY = new Color(224, 224, 255);
    public static Color TEXT_SECONDARY = new Color(160, 160, 192);
    public static Color TEXT_MUTED = new Color(96, 96, 128);
    public static Color SUCCESS = new Color(0, 255, 136);
    public static Color ERROR = new Color(255, 51, 85);

    private static ClientSetting.ThemePreset appliedPreset = null;
    private static ClientSetting.ThemeMode appliedMode = null;

    public static final int PANEL_RADIUS = 3;
    public static final int SECTION_RADIUS = 2;
    public static final int CARD_RADIUS = 1;
    public static final int CHIP_RADIUS = 999;
    public static final int PANEL_SHADOW_ALPHA = 60;
    public static final int POPUP_SHADOW_ALPHA = 80;
    ...
    public static final float CONTROL_RADIUS = 1.0f;
        ...
        private static ThemePalette forPreset(ClientSetting.ThemePreset preset, ClientSetting.ThemeMode mode) {
            return switch (preset) {
                case TonalSpot -> mode == ClientSetting.ThemeMode.Dark
                        ? paletteDark("#0A0A0F", "#06060A", "#0F0F1A", "#161625", "#1E1E30", "#00D4FF", "#001A24", "#003349", "#B3F0FF", "#FF00AA", "#2A0012", "#4A002A", "#FFB3E0", "#00FF88", "#002A14", "#004D28", "#B3FFD4")
                        : paletteLight("#F0F0FF", "#E6E6F5", "#DBDBEE", "#CFCFE6", "#C4C4DF", "#0078A8", "#FFFFFF", "#B3F0FF", "#001A24", "#C0007E", "#FFFFFF", "#FFB3E0", "#2A0012", "#00A85C", "#FFFFFF", "#B3FFD4", "#002A14");
