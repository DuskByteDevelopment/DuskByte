package com.github.duskbyte.gui.panel.panel.clientsettings;
...
import com.github.duskbyte.gui.panel.popup.ConfirmActionPopup;
import com.github.duskbyte.gui.panel.popup.MessagePopup;
import com.github.duskbyte.gui.panel.popup.PanelPopupHost;
import com.github.duskbyte.gui.panel.utils.PanelContentBuffer;
import com.github.duskbyte.gui.panel.utils.PanelContentInvalidationState;
import com.github.duskbyte.gui.panel.utils.ScrollBarDragState;
import com.github.duskbyte.gui.panel.utils.ScrollBarUtils;
...
public class ConfigClientSettingTab implements ClientSettingTabView {
    ...
    private static final TranslateComponent inputPlaceholderComponent = DuskTranslate.create("gui", "config.input.placeholder");
    private static final TranslateComponent currentComponent = DuskTranslate.create("gui", "config.current");
    private static final TranslateComponent switchHintComponent = DuskTranslate.create("gui", "config.switch_hint");
    private static final TranslateComponent emptyComponent = DuskTranslate.create("gui", "config.empty");
    private static final TranslateComponent saveAsComponent = DuskTranslate.create("gui", "config.action.saveas");
    private static final TranslateComponent reloadComponent = DuskTranslate.create("gui", "config.action.reload");
    private static final TranslateComponent exportComponent = DuskTranslate.create("gui", "config.action.export");
    private static final TranslateComponent importComponent = DuskTranslate.create("gui", "config.action.import");
    private static final TranslateComponent deleteConfirmTitleComponent = DuskTranslate.create("gui", "config.delete.confirm.title");
    private static final TranslateComponent deleteConfirmMessageComponent = DuskTranslate.create("gui", "config.delete.confirm.message");
    private static final TranslateComponent deleteConfirmConfirmComponent = DuskTranslate.create("gui", "config.delete.confirm.confirm");
    private static final TranslateComponent deleteConfirmCancelComponent = DuskTranslate.create("gui", "config.delete.confirm.cancel");
    private static final TranslateComponent errorTitleComponent = DuskTranslate.create("gui", "config.error.title");
    private static final TranslateComponent errorOkComponent = DuskTranslate.create("gui", "config.error.ok");
    private static final TranslateComponent saveErrorComponent = DuskTranslate.create("gui", "config.error.save");
    private static final TranslateComponent reloadErrorComponent = DuskTranslate.create("gui", "config.error.reload");
    private static final TranslateComponent exportErrorComponent = DuskTranslate.create("gui", "config.error.export");
    private static final TranslateComponent importErrorComponent = DuskTranslate.create("gui", "config.error.import");
    private static final TranslateComponent switchErrorComponent = DuskTranslate.create("gui", "config.error.switch");
    private static final TranslateComponent deleteErrorComponent = DuskTranslate.create("gui", "config.error.delete");
    private static final TranslateComponent deleteLastErrorComponent = DuskTranslate.create("gui", "config.error.delete_last");
    private static final TranslateComponent exportSuccessTitleComponent = DuskTranslate.create("gui", "config.export.success.title");
    private static final TranslateComponent exportSuccessMessageComponent = DuskTranslate.create("gui", "config.export.success.message");
    ...
    private void trySaveAs() {
        ...
        try {
            ...
            DuskByte.LOGGER.error("保存配置失败", exception);
    ...
    private void tryReload() {
        try {
            ...
            DuskByte.LOGGER.error("重载配置失败", exception);
    ...
    private void tryExport() {
        try {
            ...
            DuskByte.LOGGER.error("导出配置失败", exception);
    ...
    private void trySwitchConfig(String configName) {
        ...
        try {
            ...
            DuskByte.LOGGER.error("切换配置失败", exception);
    ...
    private void tryDeleteConfig(String configName) {
        try {
            ...
            DuskByte.LOGGER.error("删除配置失败", exception);
