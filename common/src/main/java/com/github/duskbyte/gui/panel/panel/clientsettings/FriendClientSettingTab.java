...
import com.github.duskbyte.managers.FriendManager;
...
public class FriendClientSettingTab implements ClientSettingTabView {
    ...
    private static final TranslateComponent noFriendsComponent = DuskTranslate.create("gui", "friend.empty");
    private static final TranslateComponent addFriendPlaceholderComponent = DuskTranslate.create("gui", "friend.input.placeholder");
