package com.github.duskbyte.gui.panel.dsl;
...
public class PanelUiCompiler {
    ...
    private static void renderSwitch(RenderTarget target, PanelLayout.Rect bounds, float toggleProgress, float hoverProgress) {
        PanelElements.drawSwitch(target.roundRectRenderer(), target.rectRenderer(), target.roundRectOutlineRenderer(), bounds, toggleProgress, hoverProgress);
    }
