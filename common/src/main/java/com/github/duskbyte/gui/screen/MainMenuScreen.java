package com.github.duskbyte.gui.screen;
...
import com.github.duskbyte.graphics.shaders.GlslSandBox;
...
public class MainMenuScreen extends Screen {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        final var background = switch (ClientSetting.INSTANCE.mainMenuBackground.getValue()) {
            ...
            case LANDSCAPE -> GlslSandBox.LANDSCAPE;
            case NEBULA -> GlslSandBox.NEBULA;
            case CYBER_FUJI -> GlslSandBox.CYBER_FUJI;
        };
    ...
    private void drawMenu(int mouseX, int mouseY) {
        ...
        Color titleColor = applyAlpha(Color.WHITE, 0.96f);
        Color subtitleColor = applyAlpha(Color.WHITE, 0.90f);
        Color accentColor = applyAlpha(MD3Theme.PRIMARY, 0.95f);

        String title = "DUSK BYTE";
        String subtitle = DuskByte.VERSION;
    ...
    private void renderEntry(MenuEntry entry, int index, int mouseX, int mouseY, float introProgress, Layout layout) {
        ...
        Color labelColor = MD3Theme.lerp(
                applyAlpha(Color.WHITE, 0.94f * appear),
                applyAlpha(Color.WHITE, 0.98f * appear),
                hover * 0.68f
        );
